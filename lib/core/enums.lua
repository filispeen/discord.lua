...
-- Discord API v10 channel and application-command context values.
M.CHANNEL_TYPE = {
...
M.APPLICATION_INTEGRATION_TYPE = { GUILD_INSTALL = 0, USER_INSTALL = 1 }
M.INTERACTION_CONTEXT = { GUILD = 0, BOT_DM = 1, PRIVATE_CHANNEL = 2 }
