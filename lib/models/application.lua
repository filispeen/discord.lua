...
function AppInfo.new(data, http)
    ...
    local self = {
        ...
        icon = data.icon,
        icon_asset = data.icon and require("./asset").from_icon(data.id, data.icon, "app-icons") or nil,
        ...
        flags = data.flags,
        application_flags = require("./flags").ApplicationFlags.new(data.flags or 0),
